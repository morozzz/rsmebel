...
class ExcelParser
{
    ...
    */
    function ExcelParser($byte_order, $biff_version)
    {
    ...
    */
    function _convertString($string)
    {
        ...
        if (strlen($string) > 255) {
            trigger_error("String is too long", E_USER_ERROR);
        }
    ...
    */
    function _fact()
    {
        ...
        trigger_error("Syntax error: ".$this->_current_token.
                      ", lookahead: ".$this->_lookahead.
                      ", current char: ".$this->_current_char, E_USER_ERROR);
    }
    ...
    */
    function _func()
    {
        ...
        /**/
            if ($num_args > 0) {
                    ...
                    $this->_current_token == SPREADSHEET_EXCEL_WRITER_SEMICOLON)
                {
                    ...
                    trigger_error("Syntax error: comma expected in ".
                                  "function $function, arg #{$num_args}", E_USER_ERROR);
                }
        ...
        if (!isset($this->_functions[$function])) {
            trigger_error("Function $function() doesn't exist", E_USER_ERROR);
        }
