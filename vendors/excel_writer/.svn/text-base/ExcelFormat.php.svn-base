...
class ExcelFormat
{
    ...
    */
    function ExcelFormat($BIFF_version, $index = 0, $properties =  array())
    {
    ...
    function setTextRotation($angle)
    {
        switch ($angle)
        {
            ...
            case -1:
                ...
                break;
            default :
                trigger_error("Invalid value for angle.".
                              " Possible values are: 0, 90, 270 and -1 ".
                              "for stacking top-to-bottom.", E_USER_ERROR);
                $this->_rotation = 0;
                break;
        }
    }
    ...
    */
    ...
    /**
     * Pseudo function for setting font family
     */
    function setFont($font_family)
    {
