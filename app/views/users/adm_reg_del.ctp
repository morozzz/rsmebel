<?php
    ...
    echo $html->div('table-caption', 'Удаление пользователя');
    ...
    echo "<div>";
        ...
        echo "</div>";
        echo "<div class=\"body-input\">";
            echo $form->input('password', array('label' => 'Пароль<font color = red> * </font>:', 'disabled' => 'true'));
        echo "</div>";
        echo "<div class=\"body-input\">";
            echo $form->input('password_confirm', array('label' => 'Подтверждение пароля<font color = red> * </font>:', 'type' => 'password', 'disabled' => 'true'));
        echo "</div>";
    echo "</div>";
...
<script type="text/javascript">
   ...
   <?php 
     if (($u_action == 'update')||($u_action == 'delete')) {
       echo "$('#UserPassword').attr('disabled', 'true');";
       echo "$('#UserPasswordConfirm').attr('disabled', 'true');";
     }
     else { 
       echo "$('#UserPassword').attr('disabled', '');";
       echo "$('#UserPasswordConfirm').attr('disabled', '');";
     }
   ?>
